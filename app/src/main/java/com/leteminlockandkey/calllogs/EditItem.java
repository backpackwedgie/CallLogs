    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etastart.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                mDatePicker = new DatePickerDialog(com.leteminlockandkey.calllogs.EditItem.this, new DatePickerDialog.OnDateSetListener() {
        ...
        etastarttime.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(com.leteminlockandkey.calllogs.EditItem.this, new TimePickerDialog.OnTimeSetListener() {
...
//        TempETAEnd = etaend.getText().toString();
    ...
    public void showDatePickerDialog(View v) {
        DialogFragment newFragment = new com.leteminlockandkey.calllogs.MainActivity.DatePickerFragment();
...
//                            URLEncoder.encode("ETAEnd","UTF-8")+"="+URLEncoder.encode(etaendHolder,"UTF-8")+"&"+
            ...
            protected void onPostExecute(String result){
                ...
                Toast.makeText(com.leteminlockandkey.calllogs.EditItem.this,"Success",Toast.LENGTH_LONG).show();
